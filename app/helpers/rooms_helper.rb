...
module RoomsHelper
  ...
  def room_create_display(subscribed,rooms)
    # The Number of rooms allowed to be created per subscription current_user.ordered_rooms.length >= 3 && subscribed == "Professional"
 
    if rooms == 15 && subscribed == "Enterprise"
      return false 
    end
